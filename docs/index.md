...
| GnuCobol 3rc *also recommended*| fixed | full support | full support | full support | full support | full support | full support |
...
| gradle cobol plugin version | gradle version |
| --------------------------- | -------------- |
|  *recommended* <br> latest, 0.0.46, >=0.46 | >= 5.4         |
| <= 0.0.45                   | <= 6.X         |
...
Or hardcode a specific version:
    ...
    plugins {
         id 'de.sebastianruziczka.Cobol' version '0.0.46'
    }
